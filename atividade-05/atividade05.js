...
const questao1 = () => {
    ...
    if (resposta1) {
        resposta1.innerText = `
            A estrutura de repetição 'for' é usada para quando quisermos repetir algum trecho de código, informamos uma variável de controle, uma condição que enquanto ela é satisfeita o trecho de código irá ser repetido e o incremento da variável de controle. 
        `;
    }
};
// Questão 2
...
const questao6 = () => {
    ...
    if (resposta6) {
        resposta6.innerText = '';
        for (let i = 0; i < 10; i++) {
            resposta6.innerText += `Repetindo 10 vezes: ${i}\n`;
        }
    }
};
// Questão 7
const questao7 = () => {
    ...
    if (resposta7) {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            resposta7.innerText += `Se repetir 5 vezes vai parar: ${i}\n`;
        }
    }
};
// Questão 8
const questao8 = () => {
    ...
    if (resposta8) {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            resposta8.innerText += `Vamos pular o 5: ${i}\n`;
        }
    }
};
// Questão 9
const questao9 = () => {
    ...
    let nomes = ['Igor', 'Karla', 'Letícia', 'Sandra', 'Filipe'];
    if (resposta9) {
        resposta9.innerText = '';
        for (let n of nomes) {
...
const questao10 = () => {
    ...
    if (resposta10) {
        ...
        for (let i = 1; i <= 10; i++) {
            resposta10.innerText += `1 até 10 em ordem crescente: ${i}\n`;
        }
    }
};
// Questão 11
const questao11 = () => {
    ...
    if (resposta11) {
        ...
        for (let i = 10; i >= 1; i--) {
            resposta11.innerText += `10 até 1 em ordem decrescente: ${i}\n`;
        }
    }
};
// Questão 12
const questao12 = () => {
    ...
    if (resposta12) {
        ...
        for (let i = 1; i <= 100; i++) {
            montante = montante + i;
            resposta12.innerText += `Somando números de 0 até 100: ${montante}\n`;
        }
    }
};
// Questão 13
const questao13 = () => {
    ...
    if (resposta13) {
        ...
        for (let i = 0; i <= 50; i++) {
            if (i % 2 === 0) {
                resposta13.innerText += `Números pares de 1 a 50: ${i}\n`;
            }
        }
    }
};
...
const questao14 = () => {
    ...
    if (resposta14) {
        ...
        let produto = 1;
        for (let i = 1; i <= 5; i++) {
            resposta14.innerText += `Produto de 1 a 5: ${produto *= i}\n`;
        }
    }
};
// Questão 15
...
const questao19 = () => {
    ...
    if (resposta19) {
        ...
        for (let i = 1; i <= 100; i++) {
            if (i % 2 === 1) {
                resposta19.innerText += `Números ímpares de 1 a 100: ${i}\n`;
            }
        }
    }
};
...
const questao20 = () => {
    ...
    if (resposta20) {
        ...
        resposta20.innerText = `Temos ${aprovados} alunos aprovados!`;
    }
};
//Questão 21
const questao21 = () => {
